...
//        assert 2 == Calculator.calculation(100, 50, '/');
        ...
        System.out.println(Calculator.calculatingDiscount(150,15));
//        System.out.println(Calculator.calculatingDiscount(10,-5)); // ArgumentException
...
//    он должен выбрасывать исключение ArithmeticException.
    public static void testCalculateDiscount() {
        // Метод выбрасывает исключение при недопустимых аргументах
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-5, 50))
                .isInstanceOf(IllegalArgumentException.class).hasMessage("Incorrect discount amount");
        ...
        assertThat(Calculator.calculatingDiscount(50, 10)).isEqualTo(45.0);
        assertThat(Calculator.calculatingDiscount(200, 20)).isEqualTo(160.0);
        assertThat(Calculator.calculatingDiscount(100, 7.5)).isEqualTo(92.5);
    }
